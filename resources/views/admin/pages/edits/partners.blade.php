...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="btn btn-primary" data-toggle="modal" data-target="#add-partner">Add New Partner</div>
        <div class="row">
            @foreach ($partners as $partner)
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="{{ $partner->secure_url }}" class="product-img-img" onclick="location.href='{{ route('partner.feature',['id' => $partner->id]) }}'">
                    </div>
                    <div class="product-info">
                        ...
                        <div class="text-center {{ $partner->feature ? 'mt-1' : 'mt-5'}}">
                        <p>{{ $partner->name }}</p>
                        </div>
                        <div class="buttons">
                        <span class="buttons-btn" data-toggle="modal" data-target="#edit-partner{{ $partner->id }}">
                        ...
                        <span class="buttons-btn"  data-toggle="modal" data-target="#delete-partner{{ $partner->id }}">
            ...
            @include('admin.modals.delete-partner',['partner' => $partner])
            @include('admin.modals.edit-partner',['partner' => $partner])
            @endforeach

        </div>
    </div>
    @include('admin.modals.add-partner')

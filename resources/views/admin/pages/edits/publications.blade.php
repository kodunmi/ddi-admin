    ...
    <div class="content-wrapper">
        <div class="page-header">
            <h3 class="page-title">
                ...
                </span> publications Edit Page </h3>
        ...
        <div class="btn btn-primary" data-toggle="modal" data-target="#add-publication">Add New publication</div>
        <div class="row">
            @foreach ($publications as $publication)
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="/images/publications/{{ $publication->image }}" class="product-img-img" onclick="location.href='{{ route('publication.feature',['id' => $publication->id]) }}'">
                    </div>
                    <div class="product-info">
                        @if ($publication->feature)
                            <div class="featured">
                        ...
                        <div class="text-center {{ $publication->feature ? 'mt-1' : 'mt-5'}}">
                        <p>{{ $publication->name }}</p>
                        <span>downloads {{ $publication->count()->sum('counts') }}</span>
                        </div>
                        <div class="buttons">
                        <span class="buttons-btn" data-toggle="modal" data-target="#edit-publication{{ $publication->id }}">
                        ...
                        <span class="buttons-btn"  data-toggle="modal" data-target="#delete-publication{{ $publication->id }}">
            ...
            @include('admin.modals.delete-publication',['publication' => $publication])
            @include('admin.modals.edit-publication',['publication' => $publication])
            @endforeach

        </div>
    </div>
    @include('admin.modals.add-publication');

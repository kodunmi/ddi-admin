...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="btn btn-primary" data-toggle="modal" data-target="#add-leader">Add New team Member</div>
        <div class="row">
            @foreach ($teams as $team)
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="/images/team/{{ $team->image }}" class="product-img-img" onclick="location.href='{{ route('team.feature',['id' => $team->id]) }}'">
                    </div>
                    <div class="product-info">
                        ...
                        <div class="text-center {{ $team->feature ? 'mt-1' : 'mt-5'}}">
                        <h3>{{ $team->name }}</h3>
                        </div>
                        <div class="buttons">
                        <span class="buttons-btn" data-toggle="modal" data-target="#edit-team{{ $team->id }}">
                        ...
                        <span class="buttons-btn"  data-toggle="modal" data-target="#delete{{ $team->id }}">
            ...
            @include('admin.modals.delete-team-member',['team' => $team])
            @include('admin.modals.edit-team-member',['team' => $team])
            @endforeach

        </div>
    </div>
    @include('admin.modals.add-team-member');

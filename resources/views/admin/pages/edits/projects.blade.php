...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="btn btn-primary" data-toggle="modal" data-target="#add-project">New Project</div>
        <div class="row">
            @foreach ($projects as $project)
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="{{ $project->images[0]->secure_url }}" class="product-img-img" onclick="location.href='{{ route('project.feature',['id' => $project->id]) }}'">
                    </div>
                    <div class="product-info">
                        ...
                        <div class="text-center {{ $project->feature ? 'mt-1' : 'mt-5'}}">
                        <h3>{{ $project->name }}</h3>
                        </div>
                        <div class="buttons">
                            <a href="{{  route('project.view',[ 'project'=> $project->id])}}">
                        ...
                        <span class="buttons-btn"  data-toggle="modal" data-target="#delete{{ $project->id }}">
            ...
            @include('admin.modals.delete-project',['project' => $project])
            @include('admin.modals.edit-project',['project' => $project])
            @endforeach

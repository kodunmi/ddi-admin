...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="btn btn-primary" data-toggle="modal" data-target="#add-leader">Add New Member</div>
        <div class="row">
            @foreach ($boards as $board)
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="{{ $board->secure_url }}" class="product-img-img" onclick="location.href='{{ route('board.feature',['id' => $board->id]) }}'">
                    </div>
                    <div class="product-info">
                        ...
                        <h3>{{ $board->name }}</h3>
                        <span class="badge badge-pill badge-primary">{{$board->type}}</span>
                        </div>
                        <div class="buttons">
                        <span class="buttons-btn" data-toggle="modal" data-target="#edit-board{{ $board->id }}">
            ...
            @include('admin.modals.delete-board-member',['board' => $board])
            @include('admin.modals.edit-board-member',['board' => $board])
            @endforeach

        </div>
    </div>
    @include('admin.modals.add-slide', ['page' => 'board'])
    @include('admin.modals.add-board-member');

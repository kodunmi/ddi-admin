...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="{{ $slide->secure_url }}" class="product-img-img" onclick="location.href='{{ route('feature', ['id' => $slide->id , 'page' => 'home' ]) }}'">
                    </div>
            ...
            @include('admin.modals.edit-slide-modal',['slide' => $slide, 'page' => 'home' ])
            @include('admin.modals.delete-slide',['slide' => $slide, 'page' => 'home' ])
            @endforeach

...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="btn btn-primary" data-toggle="modal" data-target="#add-testimony">Add New testimony</div>
        <div class="row">
            @foreach ($testimonies as $testimony)
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="{{ $testimony->secure_url }}" class="product-img-img" onclick="location.href='{{ route('testimony.feature',['id' => $testimony->id]) }}'">
                    </div>
                    <div class="product-info">
                        ...
                        <div class="text-center {{ $testimony->feature ? 'mt-1' : 'mt-5'}}">
                        <p>{{ $testimony->name }}</p>
                        <p>{{ $testimony->designation }}</p>
                        </div>
                        <div class="buttons">
                        <span class="buttons-btn" data-toggle="modal" data-target="#edit-testimony{{ $testimony->id }}">
                        ...
                        <span class="buttons-btn"  data-toggle="modal" data-target="#delete-testimony{{ $testimony->id }}">
            ...
            @include('admin.modals.delete-testimony',['testimony' => $testimony])
            @include('admin.modals.edit-testimony',['testimony' => $testimony])
            @endforeach
        </div>
    </div>
    @include('admin.modals.add-testimony');

...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="btn btn-primary" data-toggle="modal" data-target="#add-photo">Add New photo</div>
        <div class="row">
            @foreach ($photos as $photo)
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="{{ $photo->secure_url }}" class="product-img-img" onclick="location.href='{{ route('photo.feature',['id' => $photo->id]) }}'">
                    </div>
                    <div class="product-info">
                        ...
                        <div class="text-center {{ $photo->feature ? 'mt-1' : 'mt-5'}}">
                        <p>{{ $photo->text }}</p>
                        </div>
                        <div class="buttons">
                        <span class="buttons-btn" data-toggle="modal" data-target="#edit-photo{{ $photo->id }}">
                        ...
                        <span class="buttons-btn"  data-toggle="modal" data-target="#delete-photo{{ $photo->id }}">
            ...
            @include('admin.modals.edit-photo',['photo' => $photo])
            @endforeach
        </div>
    </div>
    @include('admin.modals.add-photo');

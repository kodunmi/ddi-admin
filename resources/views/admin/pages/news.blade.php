...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="btn btn-primary" data-toggle="modal" data-target="#add-news">Add New News</div>
        <div class="row">
            @foreach ($news as $news)
            <div class="col-md-4">
                <div class="wrapper">
                    {{-- <div class="product-img">
                        <img  src="{{ $news->image }}" class="product-img-img" onclick="location.href='{{ route('news.feature',['id' => $news->id]) }}'">
                    </div> --}}
                    <div class="product-info" style="width: 100%">
                        ...
                        <div class="text-center {{ $news->feature ? 'mt-1' : 'mt-5'}}">
                        <p>{{ $news->title }}</p>
                        <p>{{ $news->link }}</p>
                        <p>{{ $news->date }}</p>
                        ...
                        <div class="buttons">
                        <span class="buttons-btn" data-toggle="modal" data-target="#edit-news{{ $news->id }}">
                        ...
                        <span class="buttons-btn"  data-toggle="modal" data-target="#delete-news{{ $news->id }}">
            ...
            @include('admin.modals.delete-news',['news' => $news])
            @include('admin.modals.edit-news',['news' => $news])
            @endforeach
        </div>
    </div>

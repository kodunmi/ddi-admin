...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="btn btn-primary" data-toggle="modal" data-target="#add-video">Add New Video</div>
        <div class="row">
            @foreach ($videos as $video)
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="{{ $video->link }}" class="product-img-img" onclick="location.href='{{ route('video.feature',['id' => $video->id]) }}'">
                    </div>
                    <div class="product-info">
                        ...
                        <div class="text-center {{ $video->feature ? 'mt-1' : 'mt-5'}}">
                        <p>{{ $video->text }}</p>
                        </div>
                        <div class="buttons">
                        <span class="buttons-btn" data-toggle="modal" data-target="#edit-video{{ $video->id }}">
                        ...
                        <span class="buttons-btn"  data-toggle="modal" data-target="#delete-video{{ $video->id }}">
            ...
            @include('admin.modals.delete-video',['video' => $video])
            @include('admin.modals.edit-video',['video' => $video])
            @endforeach
        </div>
    </div>
    @include('admin.modals.add-video');

...
@section('content')
 <div class="content-wrapper">
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-12">
                <h3 class="mt-2 mb-2">Add tags</h3>
                <form action="{{ route('tag.create')}}" method="POST">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" id="widget1" class="form-control" placeholder="add new tags" required name="tags">
                            <div class="input-group-prepend">
                                <button type="submit" class="input-group-text bg-gradient-primary text-white">Add Tags</button>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="row mt-2">
            @if ($tags->count() > 0)
                @foreach ($tags as $tag)
                <div style="padding: 3px 5px; border: 2px solid black; margin-right: 5px; font-size:20px; margin-top:7px;">{{ $tag->name }}</div>
                @endforeach
            @endif
        </div>
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="{{ $post->secure_url }}" class="product-img-img" onclick="location.href='{{ route('blog.feature',['id' => $post->id]) }}'">
                    </div>

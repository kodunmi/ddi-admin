...
@section('content')
    <div class="content-wrapper">
        ...
        <div class="btn btn-primary" data-toggle="modal" data-target="#add-meeting">Add New meeting</div>
        <div class="row">
            @foreach ($meetings as $meeting)
            <div class="col-md-6">
                <div class="wrapper">
                    <div class="product-img">
                        <img  src="/images/meetings/{{ $meeting->image }}" class="product-img-img" onclick="location.href='{{ route('meeting.feature',['id' => $meeting->id]) }}'">
                    </div>
                    <div class="product-info">
                        ...
                        <div class="text-center {{ $meeting->feature ? 'mt-1' : 'mt-5'}}">
                        <a href="{{ route('meeting.show',['meeting' => $meeting->id]) }}">{{ $meeting->name }}</a>
                        <p>{{ $meeting->tool->what_we_do }} - {{ $meeting->tool->name }}- {{ $meeting->photos->count() }}</p>

                        </div>
                        <div class="buttons">
                        <span class="buttons-btn" data-toggle="modal" data-target="#edit-meeting{{ $meeting->id }}">
                        ...
                        <span class="buttons-btn"  data-toggle="modal" data-target="#delete-meeting{{ $meeting->id }}">
            ...
            @include('admin.modals.delete-meeting',['meeting' => $meeting])
            @include('admin.modals.edit-meeting',['meeting' => $meeting])
            @endforeach
        </div>
    </div>
    @include('admin.modals.add-meeting')

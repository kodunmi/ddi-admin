<div id="add-tool" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="my-modal-title">Add Tool</h5>
                <button class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="{{route('tool.create')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body text-center">
                    <div class="form-group">
                        <label for="what_we_do">the tool is for ?</label>
                        <select class="custom-select" name="what_we_do" id="what_we_do">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Name of the tool" required name="name">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="color" class="form-control" placeholder="select color for the tool" required name="color">
                        </div>
                    </div>

...
<section class="section-padding section-bg-img" style="background-image: url('/images/home/democracy.jpg'); ">

<div>
    <div class="row">
        <div class="col-md-12">
            <div class="section-heading text-center">
                <h2 class="section-title wow fadeInUpXsd" data-wow-duration=".7s" data-wow-delay=".1s"><span class="base-color">Democracy</span> </h2>
    ...
    <div class="row">
        ...
        <div class="col-md-6 wow fadeInUpXsd" data-wow-duration=".7s" data-wow-delay=".2s">
            <div class="course">
                <div class="course-preview center" style="background-color: {{ $tool->color }}">
                    <i class="icon fa fa-{{ $tool->icon }}" aria-hidden="true"></i>
                    {{--  <h3 class="text-light">{{ $tool->name }}</h3>  --}}
